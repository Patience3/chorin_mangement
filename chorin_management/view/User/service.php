...
if ($result) {
    ...
    echo "Error fetching job categories: " . mysqli_error($conn);
}
...
$sql = "SELECT Jobs.jobId, JobCategories.categoryName, Jobs.job_address, Jobs.status, Cleaners.name AS cleanerName, Jobs.description
        ...
        WHERE Users.email = ? AND Jobs.status = 'Pending'";
                        ...
                        <div class="navbar navbar-expand-lg bg-light navbar-light">
                            ...
                            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                <div class="navbar-nav ml-auto">
                                    ...
                                    <a href="service.php" class="nav-item nav-link active">Dashboard</a>
                                ...
                                <tbody>
                                    <?php foreach ($jobs as $index => $job) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../../actions/mark_job_complete_action.php?jobId=<?php echo $job['jobId']; ?>">Mark Complete</a> |
                                                <a href="../../actions/edit_job_action.php?jobId=<?php echo $job['jobId']; ?>">Edit</a> |
                                                <form method="POST" action="../../actions/delete_job_action.php" style="display:inline;" id="deleteForm_<?php echo $job['jobId']; ?>">
                                                    <input type="hidden" name="jobId" value="<?php echo $job['jobId']; ?>">
                                                    <button type="button" onclick="confirmDelete(<?php echo $job['jobId']; ?>)">Delete</button>
                                                </form>
                                                <script>
                    ...
                    <?php foreach ($jobCategories as $category) : ?>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                <img src="img/service-<?= $category['categoryId'] ?>.jpg" alt="Service"> <!-- Adjust the image source as needed -->
                                <h3><?= htmlspecialchars($category['categoryName']) ?></h3>
                                <p><?= htmlspecialchars($category['description']) ?></p>
                                <a class="btn" href="form.php?categoryId=<?= $category['categoryId'] ?>">Book a service</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
